                        ...
                        <div class="col-lg-4  col-md-6 col-12 border-end border-2">
                            <div class="review-inner ">
                                ...
                                <div class="py-3 border-bottom border-1">
                                    ...
                                    <a href="{{route('customer.edit.profile')}}"><p class="mb-0 text-grey">Profile </p></a>
                                    <a href="{{route('customer.edit.saved.card')}}"><p class="mb-0">Saved Cards</p></a>
                                    <a href="{{route('customer.address')}}"><p class="mb-0">Addresses</p></a>
                                </div>
                                <div class="py-3">
