...
<meta property="og:image" content="{{asset('assets\customer\images\photonshare_image.png')}}">
<meta property="twitter:image" content="{{asset('assets\customer\images\photonshare_image.png')}}">
