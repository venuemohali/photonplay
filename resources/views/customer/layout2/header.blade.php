                ...
                <div class="container">
                    ...
                    <div class="collapse header-font navbar-collapse " id="navbarSupportedContent">
                                    ...
                                    <li class="d-flex flex-wrap gap-5">
                                        <div class="col-md-2">
                                            ...
                                            <ul>
                                                ...
                                                <li><a class="text-wrap dropdown-item px-0 text-uppercase mb-2" href="#">Variable
                                                        Message
                                                        Sign (VMS)</a>
                                                </li>
                                                <li><a class="text-wrap dropdown-item px-0 text-uppercase mb-2 text-wrap" href="#">Variable
                                                        Speed Limit
                                                        Sign
                                                        (VSLS)</a></li>
                                                <li><a class="text-wrap dropdown-item px-0 text-uppercase mb-2" href="#">Portable
                                                        Variable
                                                        Message Sign
                                                        (PVMS) </a></li>
                                            ...
                                            <ul>
                                                ...
                                                <ul>
                                                    <li><a href="#" class="text-wrap dropdown-item px-0 text-uppercase mb-2">Radar
                                                            Speed Sign </a></li>
                                                    <li><a href="#" class="text-wrap dropdown-item px-0 text-uppercase mb-2">Portable
                                                            Variable Message Sign (PVMS)</a></li>
                                                    <li><a href="#" class="text-wrap dropdown-item px-0 text-uppercase mb-2">Variable
                                        ...
                                        <div class="col-md-2">
                                            <ul>
                                                ...
                                                <li><a href="#" class="text-wrap dropdown-item px-0 text-uppercase text-wrap mb-2">Signages
                                                        – Emergency
                                                        Exit Sign ,
                                        ...
                                        <div class="col-md-2">
                                            <ul>
                                                ...
                                                <li><a href="#" class="text-wrap dropdown-item px-0 text-uppercase mb-2">Passenger
                                                        Information Display
                                                        System <br> (PIDS) </a></li>
                        ...
                        <form class=" d-flex header-side mt-lg-0 mt-4 align-items-center" role="search">
                            ...
                            <img src="{{asset('assets\customer\images\search.png')}}" alt="Not Found" class="img-fluid" width="18px" height="18px">
                        </form>
                    </div>
                </div>
            </nav>
