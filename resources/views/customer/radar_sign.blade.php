                    ...
                    <div>
                        ...
                        <div class="d-md-flex justify-content-between align-items-center gap-3 mb-3">
                            <div class="specification p-3 w-100">
                                <h6> <img src="{{ asset('assets\customer\images\low-battery.png') }}" alt="Not Found" class="me-2">
                                    Batteries
                                </h6>
                                <p> <img src="{{ asset('assets\customer\images\check.png') }}" alt="Not Found" class="me-2"> 3 Days (+$0)
                                </p>
                                <p class="mb-0"><img src="{{ asset('assets\customer\images\check-copy.png') }}" alt="Not Found" class="me-2"> 6 Days
                                    (+$50)
                                </p>
                            </div>
                            <div class="specification p-3 w-100 mt-4 mt-md-0">
                                ...
                                <p> <img src="{{ asset('assets\customer\images\check.png') }}" alt="Not Found" class="me-2"> No (+$0)
                                </p>
                                <p class="mb-0"><img src="{{ asset('assets\customer\images\check-copy.png') }}" alt="Not Found" class="me-2">
                                    Yes (+$80)
                                </p>
                            </div>
                        </div>
                        <div class="d-md-flex justify-content-between align-items-center gap-3 mb-3">
                            <div class="specification p-3 w-100">
                                ...
                                <p> <img src="{{ asset('assets\customer\images\check.png') }}" alt="Not Found" class="me-2"> Solar (+$0)
                                </p>
                                <p class="mb-0"><img src="{{ asset('assets\customer\images\check-copy.png') }}" alt="Not Found" class="me-2">
                                    AC (+$50)
                                </p>
                            ...
                            <div class="specification p-3 w-100 mt-4 mt-md-0">
                                ...
                                <p> <img src="{{ asset('assets\customer\images\check.png') }}" alt="Not Found" class="me-2"> Pole Mount
                                    (+$0)</p>
                                <p class="mb-0"><img src="{{ asset('assets\customer\images\check-copy.png') }}" alt="Not Found" class="me-2"> Dolly (+$30)
                                </p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <img src="{{ asset('assets\customer\images\add-to-cart (1).svg') }}" alt="Not Found" class="img-fluid">
                                </div>
                            </div>
            ...
            <div class=" col-lg-4 col-md-4">
                <div class="d-md-flex  justify-content-end mt-lg-0 mt-4 buy-right align-items-center">
                    <div class="d-flex order-input">
                        ...
                        <input type="text" name="text" id="" placeholder="1" class="w-100 h-100 rounded-0 border-1 text-center border-light border-1">
                        <button class="btn border rounded-0 px-3">+</button>
                    </div>
