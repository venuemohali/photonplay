        ...
        <div class="container">
            <div class="slider-content ">
                <div class="image-smart">
                    <h2 class="text-center text-white fw-normal mb-5">Variable Message Signs</h2>
                    <img src="{{asset('assets/customer/images/banner-image-smart-city.png')}}" alt="alt" class="d-block mx-auto img-fluid">
                </div>
                <div class="smart-links text-center mt-5">
                    <a href="">STANDARD VMS</a>
                    <a href="" class="mx-1">SOLAR VMS</a>
            ...
            <div class="feature-list">
                ...
                <div class="d-lg-flex justify-content-between">
                    ...
                    <ul class="w-100">
                        ...
                        <li>
                            <div class="content-feature">
                                <strong>INBUILT ENVIRONMENTAL SENSORS Integration with ITMS </strong>
                                <!-- <span>Maintenance Free Operation with dry cell sealed batteries.</span> -->
                            </div>
                        </li>
                    </ul>
    ...
    <section class="application-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="application-item">
                        <img src="{{asset('assets/customer/images/earth.png')}}" alt="image">
                        <div class="content-application-item">
                            <h4 class="text-uppercase">Weather forecasting </h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="application-item">
                        <img src="{{asset('assets/customer/images/trucks.png')}}" alt="image">
                        <div class="content-application-item">
                            <h4 class="text-uppercase">Emergency response source integration </h4>
                            <p>to provide instant alerts to road users & public Photos </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="contact-sec-info">
                        ...
                        <div class="contact-info">
                            <div class="contact-info-item">
                                <a class="text-decoration-none" href="#"><img src="./assets/images/phone-color.png">
                                    800.966.9329 (US)</a>
                                <a class="text-decoration-none" href="#"><img src="./assets/images/phone-color.png">
                                    800.966.9329 (US)</a>
                                <a class="text-decoration-none" href="#"><img src="./assets/images/message-color.png">
