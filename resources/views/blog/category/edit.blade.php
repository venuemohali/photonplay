        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/admin/blog-categories/'.$item->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category') ?? $item->category ?? ''}}" required autocomplete="category" autofocus>
