            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="w-100 d-flex justify-content-center">
                        ...
                        <img src="{{asset('storage/'.$data->image)}}" alt="Image banner" id="output"  style="height:300px;max-height:300px;" class="w-75 m-2"/>

                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{route("admin.banners_update",$data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') ?? $data->image ?? ''}}"  autocomplete="image" onchange="loadFile(event)"   autofocus>
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="order" type="number" class="form-control @error('order') is-invalid @enderror" name="order" value="{{ old('order') ?? $data->order ?? ''}}"  autocomplete="order" autofocus>
