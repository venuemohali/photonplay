    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s_blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="post-item mb-4">
                        <a href="<?php echo e(route("customer.blog_show",$s_blog->slug)); ?>" > <img src="<?php echo e(asset("storage/".$s_blog->image)); ?>" alt="" class="mb-4 img-fluid w-100"> </a>
                        <div class="mb-4 pb-4 post-info">
                            <a href="<?php echo e(route("customer.blog_show",$s_blog->slug)); ?>"   class="text-decoration-none">   <h2 class="text-uppercase"> <b>   <?php echo e($s_blog->title); ?> </b></h2></a>
                            <div><?php echo e($s_blog->blog_created_date); ?> by <?php echo e($s_blog->author); ?></div>
                            <p>
                                <?php echo e($s_blog->description); ?>

                            </p>
                        </div>
                        <div class="post-action d-flex justify-content-between">
                            <a href="<?php echo e(route("customer.blog_show",$s_blog->slug)); ?>" class="text-decoration-none text-secondary">READ MORE</a>
                            <div class="post-action-fire">
                                <ul class="d-flex p-0 m-0 align-items-center">

                                    <li class="text-secondary">  <i class="bi bi-suit-heart-fill"></i> <?php echo e($s_blog->likes); ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/blog_listing.blade.php ENDPATH**/ ?>