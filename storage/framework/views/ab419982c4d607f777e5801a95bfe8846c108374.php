...
<?php $__env->startSection('breadcrumb-items'); ?>
    ...
    <li class="breadcrumb-item">Banner Edit</li>
<?php $__env->stopSection(); ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="w-100 d-flex justify-content-center">
                        ...
                        <img src="<?php echo e(asset('storage/'.$data->image)); ?>" alt="Image banner" id="output"  style="height:300px;max-height:300px;" class="w-75 m-2"/>

                    </div>

                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route("admin.banners_update",$data->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="image" value="<?php echo e(old('image') ?? $data->image ?? ''); ?>"  autocomplete="image" onchange="loadFile(event)"   autofocus>
...
<?php echo $__env->make('user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/banner/edit.blade.php ENDPATH**/ ?>