...
<?php if (isset($component)) { $__componentOriginal1a6bf4f7043026e4ed1b6a14e84af28717cd54f0 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Customer\HomePageBanner::class, []); ?>
<?php $component->withName('Customer.HomePageBanner'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal1a6bf4f7043026e4ed1b6a14e84af28717cd54f0)): ?>
<?php $component = $__componentOriginal1a6bf4f7043026e4ed1b6a14e84af28717cd54f0; ?>
<?php unset($__componentOriginal1a6bf4f7043026e4ed1b6a14e84af28717cd54f0); ?>
<?php endif; ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 pe-lg-0">
                            <div class="sucess-undeafeted p-4 py-5 text-white">
                                ...
                                <a href="<?php echo e(route('customer.contact.us')); ?>" class="btn btn-whites bg-white rounded-0 text-uppercase btn-light px-4">WORK
                                    WITH
                                    US</a>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item <?php echo e($loop->index === 0 ? 'active' : ''); ?>">
                        <div class="products-two d-lg-flex justify-content-between">
                            ...
                            <div class="mask-layer common-wdth inner-col text-center">
                               ...
                               <div>
                               <a href="<?php echo e(route('customer.radar.sign',$product->id)); ?>" class="btn btn-primary text-capitalize  py-0 px-3 m-auto mt-3 mb-4">Shop
                                    Now</a>
                               </div>
                            </div>
                            <div class="d-lg-flex align-items-start flex-column common-wdth inner-col">
                                <div class="ms-md-5">
                                    ...
                                    <div class="social-two">
                                        ...
                                        <a href="#" onclick="shareOnSocialMedia('<?php echo e(url()->current()); ?>',1)">  <img src="/assets/customer/images/facebook2.png" class="ms-0" alt="facebook"></a>


                                        <a href="#" onclick="shareOnSocialMedia('<?php echo e(url()->current()); ?>',2)">
                                            <img src="/assets/customer/images/twitter2.png" alt="Twitter"></a>

                                        <a href="#" onclick="shareOnSocialMedia('<?php echo e(url()->current()); ?>',3)">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-4 mb-xl-0">
                    <a href="<?php echo e(route('customer.solution.highway')); ?>" style="text-decoration: none;">
                    <div class="application-item">
                        <img src="<?php echo e(asset('assets/customer/images/Highway-Icons.png')); ?>" alt="image">
                ...
                <a href="<?php echo e(route('customer.solution.tunnel')); ?>" style="text-decoration: none;">
                <div class="application-item">
                <img src="<?php echo e(asset('assets/customer/images/Tunnels-Icons.png')); ?>" alt="image">
                        <div class="content-application-items members-profile h-100">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-4 mb-xl-0">
                <a href="<?php echo e(route('customer.solution.city')); ?>" style="text-decoration: none;">
                <div class="application-item">
                <img src="<?php echo e(asset('assets/customer/images/Smart-cities-icon.png')); ?>" alt="image">
                ...
                <a href="<?php echo e(route('customer.solution.tunnel')); ?>" style="text-decoration: none;">
                <div class="application-item">
                <img src="<?php echo e(asset('assets/customer/images/Transits-Icons.png')); ?>" alt="image">
                        <div class="content-application-items members-profile h-100 application-item">
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/homepage.blade.php ENDPATH**/ ?>