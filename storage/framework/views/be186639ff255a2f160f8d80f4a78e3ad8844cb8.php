...
<?php $component = $__env->getContainer()->make(App\View\Components\Admin\PageNavigator::class, ['page' => 4,'pid' => $id]); ?>
...
<?php endif; ?>
                    ...
                    <div class="card-body ">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.manage.solution.update.single.image')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <form method="POST" action="<?php echo e(route('admin.manage.solution.update.multi.image')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="page_id" value="<?php echo e($id); ?>">
                            <div class="row mb-3 form-group  d-flex align-items-center">
...
<?php echo $__env->make('user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/solution_pages/page_images.blade.php ENDPATH**/ ?>