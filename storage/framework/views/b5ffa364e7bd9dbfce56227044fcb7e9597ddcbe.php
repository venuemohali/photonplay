        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 col-xs-12 mb-xl-0 mb-4">
                    <div class="members-profile h-100">
                        <div class="p-4 ">
                            <img class="profile-placeholder" src="<?php echo e(asset('storage/'.$member->image)); ?>" alt="<?php echo e($member->name); ?>">
                            <h6 class="text-capitalize"><?php echo e($member->name); ?></h6>
                            <p class="text-center"> <?php echo e($member->detail); ?>
...
<?php /**PATH C:\xampp\htdocs\photonplay\resources\views/customer/homepage.blade.php ENDPATH**/ ?>