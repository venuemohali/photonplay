            ...
            <div class="row">
                ...
                <div class="col-lg-6 ">
                    <div class="radar-icop-images d-flex justify-content-center align-items-center">
                        ...
                        <img src="<?php echo e(asset('assets\customer\images\converted.png')); ?>" alt="Not Found" class="img-fluid bg-white">
                    </div>
                </div>
            </div>
        </div>
...
<?php $__currentLoopData = $product->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('customer.pvms.i.cop', $item->id)); ?>" class="text-decoration-none">
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="text-start p-4 list-unsorted">
                        <div class="roundedd-image">
                            <img src="<?php echo e(asset('assets\customer\images\Photonplay-MTO.png')); ?>" alt="Not Found" class="img-fluid">
                        </div>
                        <div class="my-3 list-bacgund px-4 py-4">
                            <h5 class="fw-bold text-capitalize"><?php echo e($item->title); ?></h5>
                            <ul>
                                <li>Batteries - 8</li>
...
<?php endif; ?>  
        ...
        <div class="container">
            <div class="row gy-5 justify-content-center">
                ...
                <div class="col-lg-4 col-md-8 col-12">
                    <div class="d-flex align-items-center justify-content-center bg-white feature-card p-4">
                        <div class="me-3 bgcolor text-center">
                            <img src="<?php echo e(asset('assets\customer\images\Comp.png')); ?>" alt="Not Found">
                        </div>
                        <div class="">
                            <h6>Compliance</h6>
                ...
                <div class="col-lg-4 col-md-8 col-12">
                    <div class="d-flex align-items-center justify-content-center bg-white feature-card p-4">
                        <div class="me-3 bgcolor text-center">
                            <img src="<?php echo e(asset('assets\customer\images\Robust.png')); ?>" alt="Not Found">
                        </div>
                        <div class="">
                            <h6>Robust</h6>
                ...
                <div class="col-lg-4 col-md-8 col-12">
                    <div class="d-flex align-items-center justify-content-center bg-white feature-card p-4">
                        <div class="me-3 bgcolor text-center">
                            <img src="<?php echo e(asset('assets\customer\images\TS.png')); ?>" alt="Not Found">
                        </div>
                        <div class="">
                            <h6>Touch Screen</h6>
                ...
                <div class="col-lg-4 col-md-8 col-12">
                    <div class="d-flex align-items-center justify-content-center bg-white feature-card p-4">
                        <div class="me-3 bgcolor text-center">
                            <img src="<?php echo e(asset('assets\customer\images\weatherss.png')); ?>" alt="Not Found">
                        </div>
                        <div class="">
                ...
                <div class="col-lg-4 col-md-8 col-12">
                    <div class="d-flex align-items-center justify-content-center bg-white feature-card p-4">
                        <div class="me-3 bgcolor text-center">
                            <img src="<?php echo e(asset('assets\customer\images\24 w.png')); ?>" alt="Not Found">
                        </div>
                        <div class="">
                ...
                <div class="col-lg-4 col-md-8 col-12">
                    <div class="d-flex align-items-center justify-content-center bg-white feature-card p-4">
                        <div class="me-3 bgcolor text-center">
                            <img src="<?php echo e(asset('assets\customer\images\SP.png')); ?>" alt="Not Found">
                        </div>
                        <div class="">
                            <h6>Solar Powered</h6>
    ...
    <section class="sepeicification  pt-md-4 pt-0 position-relative">
        ...
        <div class="container pb-lg-5">
            ...
            <img class="dotted-imag img-fluid d-none d-md-inline" src="<?php echo e(asset('assets\customer\images\dotted-tran.png')); ?>" alt="not-found">
    </section>
    <!-- Dimension section -->
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="connectivity-box text-white text-center p-4 mb-3 mb-md-0">
                        <div
                            ...
                            <img src="<?php echo e(asset('assets\customer\images\on-the-sign.png')); ?>" alt="" class="object-fit-contain">
                        </div>
                        <h4>On The Sign</h4>
                ...
                <div class="col-md-4">
                    <div class="connectivity-box text-white text-center p-4 mb-3 mb-md-0">
                        <div
                            class="connectivity-box__  mx-auto mb-2 bg-white rounded-circle d-flex align-items-center justify-content-center">
                            <img src="<?php echo e(asset('assets\customer\images\remote.png')); ?>" alt="" class="object-fit-contain">
                        </div>
                        <h4>Remote</h4>
                ...
                <div class="col-md-4">
                    <div class="connectivity-box text-white text-center p-4 mb-md-0">
                        <div
                            class="connectivity-box__  mx-auto mb-2 bg-white rounded-circle d-flex align-items-center justify-content-center">
                            <img src="<?php echo e(asset('assets\customer\images\blu.png')); ?>" alt="" class="object-fit-contain">
                        </div>
                        <h4>Near The Sign</h4>
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/portable_variable_message_signs.blade.php ENDPATH**/ ?>