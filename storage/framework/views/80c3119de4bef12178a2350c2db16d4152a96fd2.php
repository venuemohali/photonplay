                                ...
                                <div class="specification p-3 ">
                                    ...
                                    <?php $__currentLoopData = $specilization->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p> <input type="checkbox" name="<?php echo e($specilization->id); ?>"
                                                   id="<?php echo e($specilization->id); ?>" type="button" title="<?php echo e($option->specialization_price); ?>" value="<?php echo e($option->id); ?>" onclick="GetSelected(this)" > <?php echo e($option->specializationoptions->option); ?> (+$<?php echo e($option->specialization_price); ?>)
                                        </p>
            ...
            <div class=" col-lg-4 col-md-4">
                <div class="d-md-flex  justify-content-end mt-lg-0 mt-4 buy-right align-items-center">
                    ...
                    <div class=" px-4 py-lg-0 py-4">
                        <span class="one-thoshand" id="total_price">$<?php echo e($product->price); ?></span>
                    </div>
...
<?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/customer/radar_sign.blade.php ENDPATH**/ ?>