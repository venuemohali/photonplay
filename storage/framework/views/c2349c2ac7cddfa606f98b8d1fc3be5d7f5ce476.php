        ...
        <div class="container">
            <div class="slider-content">
                <div class="imaged m-auto">
                    <img src="<?php echo e(asset('assets/customer/images/banner-image-smart-city.png')); ?>" alt="alt"
                        class="d-block mx-auto img-fluid">
                    <div class="d-flex mt-4 justify-content-center gap-4 align-items-end">
                        <img src="<?php echo e(asset('assets/customer/images/zero-mentence.png')); ?>" alt="alt"
                            class="d-block mx-auto img-fluid">
                        <img src="<?php echo e(asset('assets/customer/images/dawrka.png')); ?>" alt="alt"
                            class="d-block mx-auto img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-10">
                    <div>
                        <p>
                            Viewed by millions of eyes everyday, guiding way to millions of motorist to drive them back
    ...
    <section class="our-product pt-lg-4">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-10">
                    <div class="row">
                        <?php $__currentLoopData = $page; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="text-start p-4 list-unsorted">
                                    ...
                                    <div class="my-3 list-bacgunded px-4 py-4">
                                        <h5 class="fw-bold text-capitalize"><?php echo e($i->title); ?></h5>
                                        <p><?php echo e(substr($i->description, 0, 60)); ?> ... </p>
                                        <a href="<?php echo e(route('customer.vms.sub.page', $i->slug)); ?>" style="text-decoration: none;">
                                            <a href="<?php echo e(route('customer.vms.sub.page', $i->slug)); ?>" style="text-decoration: none;"><h6 class="text-colorr">Explore More >></h6></a>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6 ">
                    <div class="d-flex justify-content-center align-items-center">
                        <img src="<?php echo e(asset('assets/customer/images/VMS_Gantry.png')); ?>" alt="Not Found"
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/variable_message.blade.php ENDPATH**/ ?>