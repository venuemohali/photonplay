...
<?php endif; ?>
                    ...
                    <div class="card-body ">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.manage.solution.update.specification.page')); ?>"  enctype="multipart/form-data" >
                            <?php echo csrf_field(); ?>
                            <input type="hidden" value="<?php echo e($editSpec->id); ?>" name="spec_id">
...
unset($__errorArgs, $__bag); ?>" name="spec" value="<?php echo e($editSpec->spec); ?>" required autocomplete="spec" autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3 form-group">
                                <label for="summernote" class="col-md-2 col-form-label text-md-end"><span>* </span><?php echo e(__('Description')); ?></label>

                                <div class="col-md-10">
                                    <textarea id="summernote" type="text" class="form-control <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="description" required autocomplete="description" autofocus><?php echo e($editSpec->description); ?></textarea>
...
<?php echo $__env->make('user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/solution_pages/edit_specification.blade.php ENDPATH**/ ?>