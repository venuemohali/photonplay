        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="text-center mb-lg-5">
                    ...
                    <p class="text-mutedd"> See What Our Satisfied Clients Have to Say About Our Innovative ITS
                        Solutions</p>
                </div>
            </div>
            <div class="col-lg-10">
                <div class="row clint-wrapperr">
                    ...
                    <?php $__currentLoopData = $client_says;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $says):
                        $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4">
                            <div class="members-profile h-100 mx-3 h-100">
                                <div class="p-4 position-relative h-100 inner-max-width">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2 d-flex flex-column align-items-center justify-content-start">
                                            ...
                                            <p class="text-capitalize mb-0 fs-6 full-names">
                                                <?php echo e($says->name); ?>
                                            </p>
                                            <p class="mb-0">
                                                <?php echo e($says->position); ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="text-start mt-3">
                                        <p>
                                            <?php echo e($says->message); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/layout2/client_testimonials.blade.php ENDPATH**/?>