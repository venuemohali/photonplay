                    ...
                    <div class="card-body ">
                        <div class="row mb-3 ">
                            <div class="rounded p-1" style="width:100%;height:300px;background-color: grey;">
                                <img src="<?php echo e(url("storage/".$data->image)); ?>" class="img-fluid h-100 w-100 " />
                            </div>

                        </div>

                        <hr/>
                        <form method="POST" action="<?php echo e(route('admin.blogs.update',$data->id)); ?>"  enctype="multipart/form-data" >
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="keywords" required autocomplete="keywords"
                                        value="<?php echo e(old('keywords') ?? $data->keywords ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>" name="image" value="<?php echo e(old('image') ?? $data->image ?? ''); ?>"  autofocus>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <select id="category" name="category_selected" class="form-select form-select" aria-label=".form-select-sm">
                                        ...
                                        <?php $__currentLoopData = $blog_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>"  <?php echo e($data->blog_category_id==$category->id?"selected":" "); ?>><?php echo e($category->category); ?></option>
...
<?php echo $__env->make('user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/blog/edit.blade.php ENDPATH**/ ?>