                    ...
                    <div class="login-parent">
                        <div class="login-parent-inner">
                            ...
                            <form action="<?php echo e(route('customer.register')); ?>" method="post">
                                ...
                                <div class="mt-5 ">
                                    <label class="d-block">Already have an account? <a href="<?php echo e(route('customer.loginForm')); ?>" class="text-colorr">Login here.</a></label>
                                </div>
...
<?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/customer/auth/register.blade.php ENDPATH**/ ?>