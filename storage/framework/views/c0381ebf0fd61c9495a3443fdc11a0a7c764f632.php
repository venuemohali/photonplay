            ...
            <div class="row">
                ...
                <div class="col-lg-6 ">
                    <div class="radar-icop-image d-flex justify-content-center align-items-center">
                        ...
                        <img src="<?php echo e(asset('assets\customer\images\iCop icon.png')); ?>" alt="Not Found" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div>
                        <div class="p-2">
                            <div class="inner-product bg-white">
                                <div class="w-100 h-100 light-product m-auto" style="background: url('<?php echo e(asset('storage/'. $product->cover_image)); ?>') no-repeat center;
                                ...
                                <div class="speed-sign text-center mt-3">
                                    ...
                                    <span class="d-block weight-font"><?php echo e($product->price); ?></span>
                                    <a href="<?php echo e(route('customer.radar.sign', $product->id)); ?>" class="btn btn-primary text-capitalize mt-3">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center bg-white feature-card p-4">
                        <div class="me-3"><img src="<?php echo e(asset('assets/customer/images/icon.png')); ?>" alt="Not Found"></div>
                        <div class="">
                            <h6>Solar Powered</h6>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center bg-white feature-card p-4">
                        <div class="me-3"><img src="<?php echo e(asset('assets/customer/images/WEATHER.png')); ?>" alt="Not Found"></div>
                        <div class="">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center bg-white feature-card p-4">
                        <div class="me-3"><img src="<?php echo e(asset('assets/customer/images/TRAFIC.png')); ?>" alt="Not Found"></div>
                        <div class="">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center bg-white feature-card p-4">
                        <div class="me-3"><img src="<?php echo e(asset('assets/customer/images/BATTERY.png')); ?>" alt="Not Found"></div>
                        <div class="">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center bg-white feature-card p-4">
                        <div class="me-3"><img src="<?php echo e(asset('assets/customer/images/COMPLIANCE.png')); ?>" alt="Not Found"></div>
                        <div class="">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center bg-white feature-card p-4">
                        <div class="me-3"><img src="<?php echo e(asset('assets/customer/images/CLUDE.png')); ?>" alt="Not Found"></div>
                        <div class="">
                        ...
                        <div class="accordion accordion-flush position-relative" id="accordionFlushExample">
                            ...
                            <div class="accordion-item border-0">
                                ...
                                <div class="d-flex justify-content-end position-absolute circle-stone">
                                    <img src="<?php echo e(asset('assets/customer/images/circle_stone.png')); ?>" alt="not-found" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="circle-floow position-relative">
                            ...
                            <div class="stone-accordian position-absolute d-flex align-items-center ">
                                <img src="<?php echo e(asset('assets/customer/images/object.png')); ?>" class="img-fluid circle-image d-none d-md-block"
                                    alt="not-found">
                            </div>
                        </div>
                    </div>
    ...
    <section class="option-chose ">
        <div class="container option-chose-rows">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="img-left">
                        <img src="<?php echo e(asset('assets/customer/images/your_speed.jpg')); ?>" alt="Not Found" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row py-4">
                ...
                <div class="col-lg-6">
                    <div class="img-left">
                        <img src="<?php echo e(asset('assets/customer/images/key-speed.jpg')); ?>" alt="Not Found" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="multiple-option pb-0">
            ...
            <div class="row py-4">
                ...
                <div class="col-lg-6">
                    <div class="img-left">
                        <img src="<?php echo e(asset('assets/customer/images/Data-analysis-cloud-radar-sign.jpg')); ?>" alt="Not Found" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="multiple-option pb-0">
            ...
            <div class="row py-4">
                ...
                <div class="col-lg-6">
                    <div class="img-left">
                        <img src="<?php echo e(asset('assets/customer/images/iMAGE-HOLDER.jpg')); ?>" alt="Not Found" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="multiple-option pb-0">
            ...
            <div class="row py-4">
                <div class="col-lg-6">
                    <div class="img-left">
                        <img src="<?php echo e(asset('assets/customer/images/trans-canada.jpg')); ?>" alt="Not Found" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="multiple-option pb-0">
            ...
            <div class="row py-4">
                <div class="col-lg-6">
                    <div class="img-left">
                        <img src="<?php echo e(asset('assets/customer/images/ballon-HOLDER.jpg')); ?>" alt="Not Found" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="multiple-option pb-0">
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/sign.blade.php ENDPATH**/ ?>