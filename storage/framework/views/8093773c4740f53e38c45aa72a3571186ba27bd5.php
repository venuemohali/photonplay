    ...
    <div class="footer-section-inner d-lg-flex">
        <div class="footer-item footer-item-1">
            ...
            <ul class="social-media pt-md-5 py-4">
                <li><a href="#"><img src="<?php echo e(asset('assets\customer\images\facebook.svg')); ?>" /></a></li>
                <li><a href="#"><img src="<?php echo e(asset('assets\customer\images\twitter.jpg')); ?>" /></a></li>
                <li><a href="#"><img src="<?php echo e(asset('assets\customer\images\linkdin.jpg')); ?>" /></a></li>
                <li><a href="#"><img src="<?php echo e(asset('assets\customer\images\instagram.png')); ?>" /></a></li>
        ...
        <div class="footer-item footer-item-5">
            ...
            <div class="contact-info">
                <div class="contact-info-item">
                    <a href="#"><img src="<?php echo e(asset('assets\customer\images\phone.svg')); ?>" /> 800.966.9329 (US)</a>
                    <a href="#"><img src="<?php echo e(asset('assets\customer\images\phone.svg')); ?>" /> 800.966.9329 (US)</a>
                    <a href="#"><img src="<?php echo e(asset('assets\customer\images\message.png')); ?>" /> sales@photonplay.com</a>
                </div>
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/components/customer/footer.blade.php ENDPATH**/ ?>