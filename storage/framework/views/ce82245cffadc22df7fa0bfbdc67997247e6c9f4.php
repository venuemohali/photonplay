...
<header class="header bg-white py-3 sticky-top">
        <nav class="navbar navbar-expand-lg custome-mega-amenu">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(route('customer.homePage')); ?>"><img src="<?php echo e(asset('assets\customer\images\logo-dark.png')); ?>" alt="Photon Plays System"></a>
                ...
                <div class="collapse header-font navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-5 mx-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-uppercase" href="<?php echo e(route('customer.homePage')); ?>">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-uppercase" href="<?php echo e(route('customer.about.us')); ?>">COMPANY</a>
                        </li>
                        <!-- hjgjhkl -->
                        ...
                        <li class="nav-item dropdown position-relative solution-pos">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                SOLUTIONS <img src="<?php echo e(asset('assets\customer\images\Down-Arrow.png')); ?>" alt="Not Found" class="ms-1 mb-">
                            </a>

                            <ul class="dropdown-menu mega-menu">
                                <li class="d-flex flex-wrap gap-5">
                                    <div class="col-md-2">
                                        <h4><a class="dropdown-item px-0 text-uppercase" href="<?php echo e(route('customer.solution.highway')); ?>">Highways</a></h4>
                                        <ul>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li><a class="text-wrap dropdown-item px-0 text-uppercase mb-2"
                                                    href="<?php echo e(route('customer.variable.message')); ?>">Variable
                                                    Message
                                                    Sign (VMS)</a>
                                            </li>
                                    ...
                                    <div class="col-md-2">
                                        <ul>
                                            <h4><a class="dropdown-item px-0 text-uppercase" href="<?php echo e(route('customer.solution.city')); ?>">Smart
                                                    Cities</a>
                                            </h4>
                                            <li>
                                                <hr class="dropdown-divider">
                                            ...
                                            <ul>
                                                <li><a href="<?php echo e(route('customer.radar.speed.signs')); ?>"
                                    ...
                                    <div class="col-md-2">
                                        <ul>
                                            <h4><a class="dropdown-item px-0 text-uppercase" href="<?php echo e(route('customer.solution.tunnel')); ?>">Tunnels</a>
                                            </h4>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            ...
                                            <li><a href="<?php echo e(route('customer.lane.control.system')); ?>"
                                    ...
                                    <div class="col-md-2">
                                        <ul>
                                            <h4><a class="dropdown-item px-0 text-uppercase" href="<?php echo e(route('customer.solution.transit')); ?>">TRANSIT</a>
                                            </h4>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-uppercase" href="<?php echo e(route('customer.blog')); ?>">NEWS & EVENTS</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-uppercase" href="<?php echo e(route('customer.contact.us')); ?>">CONTACT</a>
                        </li>
                    </ul>
                    <form class=" d-flex mt-lg-0 mt-4 align-items-center" role="search" method="get" action="<?php echo e(route('customer.search_photon_things')); ?>">
                        ...
                        <div class="position-relative search-heading">
                            <input class="form-control me-2 shadow-none border"  name="search" type="search" placeholder="Search" aria-label="Search" value="<?php echo e($query??""); ?>" />
                            <div class="position-absolute top-50 end-0 translate-middle">
                                
                                <img src="<?php echo e(asset('assets\customer\images\search.png')); ?>" alt="Not Found" class="img-fluid me-2" width="18px"
                                     height="18px">
                            </div>
                        </div>
                    </form>
                ...
                <div class="row ">
                    <div class="col-lg-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a class="mega-brand" href="<?php echo e(route('customer.homePage')); ?>"><img src="<?php echo e(asset('assets\customer\images\logo-dark.png')); ?>" alt="Not Found"></a>
                            <div class="toggler-mega "><img src="<?php echo e(asset('assets\customer\images\icons8-menu-50.png')); ?>" alt=""></div>
                ...
                <li>
                    ...
                    <div class="mega-menu mt-4">
                        <div class="mega-menu-items">
                            <a href="<?php echo e(route('customer.homePage')); ?>" class="text-decoration-none text-dark"> <h4 class="text-uppercase">Home</h4> </a>
                        </div>
                        <div class="mega-menu-items">
                            <a href="<?php echo e(route('customer.about.us')); ?>"  class="text-decoration-none text-dark"> <h4 class="text-uppercase">Company</h4></a>
                        </div>
                        ...
                        <form class=" d-flex mt-lg-0 mt-4 align-items-center" role="search">
                            ...
                            <div class="position-relative search-heading">
                                ...
                                <div class="position-absolute top-50 end-0 translate-middle">
                                    <img src="<?php echo e(asset('assets\customer\images\search.png')); ?>" alt="Search" class="img-fluid me-2" width="18px"
                                         height="18px">
                                </div>
                            </div>
                        </form>
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/layout2/header.blade.php ENDPATH**/ ?>