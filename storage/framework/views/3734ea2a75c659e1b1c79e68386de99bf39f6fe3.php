    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-lg-12 col-md-12 mb-2">
               <h4 class="text-dark">  <?php echo e($record->title); ?></h4>
                <hr/>
                <?php if(isset($record->image)): ?>
               <img src="<?php echo e(asset('storage/'.$record->image)); ?>"  class="img-fluid w-100 shadow-lg"/>
                <?php endif; ?>
            </div>
...
<?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/customer/policy_page.blade.php ENDPATH**/ ?>