<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="<?php echo e(url('/')); ?>"><img class="img-fluid"
                        src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt="">
                </a></div>
        ...
        <div class="nav-right col-8 pull-right right-header p-0">
          ...
          <div class="translate_wrapper">
            ...
            <div class="more_lang">
              <a href="<?php echo e(url('lang', 'en')); ?>" class="<?php echo e(App::getLocale() == 'en' ? 'active' : ''); ?>">
              ...
              <a href="<?php echo e(url('lang', 'de')); ?>" class="<?php echo e(App::getLocale() == 'de' ? 'active' : ''); ?> ">
              ...
              <a href="<?php echo e(url('lang', 'es')); ?>" class="<?php echo e(App::getLocale() == 'en' ? 'active' : ''); ?>">
              ...
              <a href="<?php echo e(url('lang', 'fr')); ?>" class="<?php echo e(App::getLocale() == 'fr' ? 'active' : ''); ?>">
              ...
              <a href="<?php echo e(url('lang', 'pt')); ?>" class="<?php echo e(App::getLocale() == 'pt' ? 'active' : ''); ?>">
              ...
              <a href="<?php echo e(url('lang', 'cn')); ?>" class="<?php echo e(App::getLocale() == 'cn' ? 'active' : ''); ?>">
              ...
              <a href="<?php echo e(url('lang', 'ae')); ?>" class="<?php echo e(App::getLocale() == 'ae' ? 'active' : ''); ?>">
        ...
        <li class="onhover-dropdown">
          ...
          <ul class="cart-dropdown onhover-show-div">
            ...
            <li><a class="btn btn-block w-100 mb-2 btn-primary view-cart" href="<?php echo e(url('cart')); ?>">Go to shoping bag</a><a class="btn btn-block w-100 btn-secondary view-cart" href="<?php echo e(url('checkout')); ?>">Checkout</a></li>
          </ul>
        </li> -->
                <!-- <li class="onhover-dropdown">
            ...
            <li class="text-center"> <a class="btn btn-primary" href="#">View All     </a></li>
                ...
                <li class="profile-nav onhover-dropdown p-0 me-md-4" style="display: block !important;">
                    ...
                    <ul class="profile-dropdown onhover-show-div me-4" style="width: 180px;">
                        ...
                        <li><a href="<?php echo e(route('admin.logout')); ?>" id="logout"
...
<?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/layouts/header.blade.php ENDPATH**/ ?>