<section class="key-project pb-0">
    ...
    <div class="key-slider mb-0">
        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div>
                <img src="<?php echo e(asset('storage/'.$banner->image)); ?>" alt="<?php echo e($banner->tagline); ?>" class="img-fluid w-100 h-50">
            </div>
...
<?php /**PATH C:\xampp\htdocs\photonplay\resources\views/components/customer/key-project.blade.php ENDPATH**/ ?>