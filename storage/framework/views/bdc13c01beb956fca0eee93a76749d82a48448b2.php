        ...
        <div class="container">
            <div class="slider-content ">
                <div class="imaged m-auto">
                    <h2 class="text-center text-white fw-normal mb-5"><?php echo e($page->title); ?></h2>
                    <img src="<?php echo e(asset('assets/customer/images/PIDS.webp')); ?>" alt="alt" class="d-block mx-auto img-fluid">
                </div>
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample1">
                                <?php $__currentLoopData = $page->specs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="accordion-item border-0 position-inherit ">
                                        <h2 class="accordion-header" id="flush-headingOne<?php echo e($spec->id); ?>">
                                            <button class="accordion-button collapsed optic bg-white te-3 pb-2 shadow-none text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne<?php echo e($spec->id); ?>" aria-expanded="false" aria-controls="flush-collapseOne<?php echo e($spec->id); ?>">
                                                <?php echo e($spec->spec); ?>

                                            </button>
                                        </h2>
                                        <div id="flush-collapseOne<?php echo e($spec->id); ?>" class="accordion-collapse collapse" aria-labelledby="flush-headingOne<?php echo e($spec->id); ?>" data-bs-parent="#accordionFlushExample1">
                ...
                <div class="d-lg-flex justify-content-between">
                    <ul class="w-100 m-0 p-0">
                       <?php
                        ...
                        $sr=1;
                       ?>
                        <?php $__currentLoopData = $page->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <div class="content-feature">
                                    <strong><?php echo e($feature->feature); ?></strong>
                                    <span><?php echo e($feature->description); ?></span>
                                </div>
                            </li>
                            <?php if($sr==$break_point): ?>
                                   </ul>
                                    <ul class="w-100 m-0 p-0">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="application-item">
                        <img src="<?php echo e(asset('assets/customer/images/application-img-1.png')); ?>" alt="image">
                ...
                <div class="col-md-6">
                    <div class="application-item">
                        <img src="<?php echo e(asset('assets/customer/images/standrooms.png')); ?>" alt="image">
                        <div class="content-application-item">
...
<?php /**PATH D:\photon_main\main_photo\photonplay\resources\views/customer/vms_sub_page.blade.php ENDPATH**/ ?>