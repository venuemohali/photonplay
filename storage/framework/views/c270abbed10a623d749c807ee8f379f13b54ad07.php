                            ...
                            <div class="about-undeafeted text-dark">
                               ...
                               <div class="justify-content-around d-flex">
                                <div>
                                    ...
                                    <span><img src="<?php echo e(asset('assets\customer\images\phone.svg')); ?>" class="me-2 mb-2"/>+1  (800) 966-9329</span>
                                    <span class="d-block"><img src="<?php echo e(asset('assets\customer\images\message.png')); ?>" class="me-2"/> sales@photonplay.com</span>
                                </div>
                                <div>
                        ...
                        <div class="col-lg-10 pe-lg-0">
                            ...
                            <!-- <div class="col-lg- mb-5"> -->
                                <div class="col-lg-6 col-md-12 mb-lg-5 mb-md-4">
                                   ...
                                   <div class="d-flex align-items-start"> <img src="<?php echo e(asset('assets\images\pin-map.png')); ?>"  class="me-2 mb-2"/> 
...
<section class="text-center">
    ...
    <div>
    <span class="text-dark"><img src="<?php echo e(asset('assets\customer\images\phone.svg')); ?>" class="me-2 mb-2"/>+1  (800) 966-9329</span>
    <span class="text-dark"><img src="<?php echo e(asset('assets\customer\images\message.png')); ?>" class="mx-2"/> sales@photonplay.com</span>
    </div>
    </div>
</section>
</section>
...
<?php /**PATH C:\Users\The Miraj\Desktop\laravell(06-05-2023)\photonplay\resources\views/customer/contact_us.blade.php ENDPATH**/ ?>